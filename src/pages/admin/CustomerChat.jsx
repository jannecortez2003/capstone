...
const CustomerChat = () => {
  ...
  return (
    <div className="p-6 h-[calc(100vh-2rem)] flex flex-col transition-colors duration-300">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-1 text-gray-800 dark:text-white transition-colors duration-300">Customer Live Chat</h1>
        <p className="text-gray-500 dark:text-gray-400 transition-colors duration-300">Respond to customer inquiries in real-time.</p>
      </div>
